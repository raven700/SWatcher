...
class Services(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.connect(self.bRun1, SIGNAL("clicked()"), self.bRun1Click)
        ...
        self.connect(self.bRun2, SIGNAL("clicked()"), self.bRun2Click)
        ...
        self.connect(self.bOnAll, SIGNAL("clicked()"), self.bOnAllClick)
        
        self.bOffAll = QtGui.QPushButton(sStopAll, self)
        self.gridLayout.addWidget(self.bOffAll, 4, 1, 1, 1)
        self.connect(self.bOffAll, SIGNAL("clicked()"), self.bOffAllClick)        
